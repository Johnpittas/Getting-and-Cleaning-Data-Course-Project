...
Libraries Used
The libraries used in this operation are data.table and dplyr. Data.table is efficient in handling large data as tables. 
...
Examining extractedData, we can say that the following acronyms can be replaced.
...
Xreate tidyData as a data set with average for each activity and subject. Then, we order the enties in tidyData and write it into data file Tidy.txt that contains the processed data.
